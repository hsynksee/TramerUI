...
@Component({
  selector: 'app-company-user-summary-report',
  templateUrl: './company-user-summary-report.component.html'
})

export class CompanyUserSummaryReportComponent implements OnInit {
  ...
  getDataSource(startDate, endDate, companyId){
    ...
    this.dataSource = new CustomStore({
      key: 'this',
      load: () => GridUtil.handleGridResponse(this.reportService.getCompanyUserSummaryReport(formattedStartDate, formattedEndDate, companyId))
    });
  }
  ...
  onExporting(event){
    event.fileName = "Kullanıcı-Raporu";
  }
